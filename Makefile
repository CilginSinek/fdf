...
SRC_BONUS= bonus/exit_utils_bonus.c bonus/exit_utils1_bonus.c bonus/filehandler_bonus.c bonus/handlevision_bonus.c bonus/imagehandler_bonus.c bonus/key_utils.c bonus/main_bonus.c bonus/utils1_bonus.c bonus/utils_bonus.c bonus/video_handle_bonus.c bonus/video_helper.c
OBJ=$(SRC:.c=.o)
